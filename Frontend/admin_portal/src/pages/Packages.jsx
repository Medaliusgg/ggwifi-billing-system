    ...
    <Box sx={{ p: isMobile ? 2 : 3, backgroundColor: '#FFFFFF', minHeight: '100vh' }}>
        ...
        <Card>
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
              Standard packages available to all customers at all times.
            </Typography>
            <Box sx={{ display: 'flex', justifyContent: 'center', py: 4 }}>
              <Typography variant="body2" color="text.secondary">
                Universal packages are shown in the Package List tab. Filter by type to view only universal packages.
              </Typography>
            </Box>
          </CardContent>
        </Card>
      ...
      {activeTab === 2 && (
        <Card>
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
              Time-bound, limited stock, event-based packages with special pricing and availability rules.
            </Typography>
            <Alert severity="info" sx={{ mb: 2 }}>
              Offer packages include time-based offers, limited stock, and special event packages.
              Configure offer rules, start/end dates, and highlight priority in package settings.
            </Alert>
            <Box sx={{ display: 'flex', justifyContent: 'center', py: 4 }}>
              <Typography variant="body2" color="text.secondary">
                Create offer packages in the Package List tab and configure offer rules in package settings.
              </Typography>
            </Box>
          </CardContent>
        </Card>
      ...
      {activeTab === 3 && (
        <Card>
          <CardContent>
            <Typography variant="h6" gutterBottom>
              Package Sync to Routers
            </Typography>
            <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
              Sync package profiles, bandwidth rules, and configurations to MikroTik routers and RADIUS pools.
            </Typography>
            <Alert severity="info">
              Package router sync is managed in the Router Management module.
              <Button 
                variant="text" 
                size="small" 
