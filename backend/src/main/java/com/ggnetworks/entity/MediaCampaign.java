...
/**
 * Media Campaign Entity
 * Stores video/image campaigns for customer portal homepage
 */
@Entity
...
public class MediaCampaign {
    ...
    public MediaCampaign(String campaignId, String title, CampaignType type, String mediaUrl) {
