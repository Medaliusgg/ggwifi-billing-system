-- FreeRADIUS SQL Configuration for GGNetworks
...
CREATE TABLE IF NOT EXISTS radacct (
    ...
    nasipaddress inet6 NOT NULL default '',
    ...
    framedipaddress inet6 NOT NULL default '',
    framedipv6address inet6 NOT NULL default '',
    framedipv6prefix inet6 NOT NULL default '',
    framedinterfaceid varchar(64) default NULL,
    delegatedipv6prefix inet6 NOT NULL default '',
